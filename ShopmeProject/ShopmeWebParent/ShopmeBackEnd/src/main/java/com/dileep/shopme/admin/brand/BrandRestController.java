...
import com.dileep.shopme.admin.category.CategoryDTO;
...
public class BrandRestController {
	...
	public String checkUnique(@Param("id") Long id,@Param("name") String name) {
		String s = brandService.checkUnique(id, name);
		return s;
	}
	
	@GetMapping("/brands/{id}/categories")
	public List<CategoryDTO> listCategoriesByBrand(@PathVariable(name="id") Long brandId) throws Exception{
